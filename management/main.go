...
func main() {
	...
	beego.Router("/dict_manage/update/", &controllers.DictUpdateController{})
	beego.Router("/dict_manage/delete/", &controllers.DictDeleteController{})
	beego.Router("/dict_manage/add/", &controllers.DictAddController{})
